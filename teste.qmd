...
```
::: title-section
<h1><font color="black" face ="arial black" size =18 >Análise da produção de Leite em um Fazenda Utilizando DBC </font></h1>

::: text-left
Joseferson Barreto<br>Graduado em Estatística<br>Universidade Estadual da Paraíba
:::

::: text-right
Dr. Tiago Almeida<br>Universidade Estadual da Paraíba
:::
:::
...
=======
# 
>>>>>>> 34d6813bd728be26f891a3327b75c06e1df46f6b
# # Garantir que a coluna dias seja um fator
# banco$dias <- factor(banco$dias, levels = unique(banco$dias))
# 
# 
# # Ordenar o conjunto de dados pelo fator dias
# banco <- banco %>%
#   arrange(dias)
# 
...
# 
# 
# data.frame(factor(banco$dias))
# teste<-banco %>% order_by(factor(banco$dias))
